...
function problemB() {
  ...
  // promise version
  promisifiedReadFile("poem-one/stanza-03.txt").then((stanza2) => {
    blue(stanza2);
  });
  promisifiedReadFile("poem-one/stanza-02.txt").then((stanza3) => {
    blue(stanza3);
  });
}
...
function problemC() {
  ...
  promisifiedReadFile("poem-one/stanza-02.txt").then((lectura2) => {
    blue(lectura2);
    return promisifiedReadFile("poem-one/stanza-03.txt").then((lectura3) => {
      blue(lectura3);
      console.log("done");
    });
  });
